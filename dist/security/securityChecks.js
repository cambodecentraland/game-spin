...
function runChecks(req, parcel) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const validOrigin = (utils_1.TESTS_ENABLED && metadata.realm.catalystName === 'localhost')
            ? true
            : checkOrigin(req);
        if (!validOrigin) {
        ...
        const validCatalystPos = (utils_1.TESTS_ENABLED && metadata.realm.catalystName === 'localhost')
            ? true
            : yield verifyOnMap_1.checkPlayer(userAddress, metadata.realm.domain, coordinates);
        if (!validCatalystPos) {
        ...
        const validPos = (parcel === null || parcel === void 0 ? void 0 : parcel.length) ? verifyOnMap_1.checkCoords(coordinates, parcel) : true;
        if (!validPos) {
